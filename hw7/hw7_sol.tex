...
\noindent
\\Therefore, according to the greedy algorithm, if the leaf node needs zero edges "at this time", it will choose nothing. If it needs one or more edge, it will choose the parent edge first, and then any of the other children edges.
