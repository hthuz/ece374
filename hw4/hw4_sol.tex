...
Find all the n that d(n)=1, cut there. Then we can get $w=a \ \vline\ w_1 \ \vline\ w_2 \ \vline\ w_3 ...\ \vline\ w_n \ \vline\ a^*$ with the weekly balanced substring $w_s$. Seperate all the $a^*$ to be single so that it will meet the requirement.\\
